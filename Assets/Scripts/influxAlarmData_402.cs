...
/// </summary>
public class InfluxAlarmDataProvider_402 : MonoBehaviour
{
    ...
    public string bucketName = "Sif 402";
    ...
    /// </summary>
    public bool[] MinFeederValues { get; private set; } = new bool[6];

    /// <summary>
    /// Stores values for bdfeeder_1 to bdfeeder_5.
    /// Access via index 1-5 (e.g., BdFeederValues[1]). Index 0 is unused.
    /// </summary>
    public bool[] BdFeederValues { get; private set; } = new bool[6];
